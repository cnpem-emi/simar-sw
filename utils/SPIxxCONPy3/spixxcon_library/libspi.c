...
static PyMethodDef spicon_funcs[] = {{"open", (PyCFunction)spi_open, METH_VARARGS, NULL},
                                     {"close", (PyCFunction)spi_close, METH_VARARGS, NULL},
                                     {"set_speed_mode", (PyCFunction)spi_mode, METH_VARARGS, NULL},
                                     {"transfer", (PyCFunction)spi_transfer, METH_VARARGS, NULL},
                                     {NULL}};

static struct PyModuleDef spicon = {PyModuleDef_HEAD_INIT, "spicon", "C code for SPI in Linux\n",
                                    -1, spicon_funcs};
